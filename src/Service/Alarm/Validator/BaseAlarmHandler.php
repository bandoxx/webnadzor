...
class BaseAlarmHandler
{
    ...
    public function finish(?DeviceAlarm $alarm, DeviceData $deviceData, $type): void
    {
    ...
    public function createAlarm(DeviceData $deviceData, $type): void
    {
        $alarm = $this->alarmFactory->create($deviceData, $type);
