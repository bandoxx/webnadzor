...
class DeviceDataUpdateController extends AbstractController
{
    ...
    public function __invoke(int $clientId, int $id, int $entry, Request $request, DeviceDataRepository $deviceDataRepository, EntityManagerInterface $entityManager): \Symfony\Component\HttpFoundation\RedirectResponse
    {
