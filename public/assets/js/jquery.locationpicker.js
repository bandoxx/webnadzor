    ...
    $.fn.extend({ 
        ...
        locationPicker: function() {
            ...
            return this.each(function() {
                ...
                var searchButton = $('<button type="button" class="picker-search-button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">Traži</span></button>');
                ...
                $(this).after(picker);
                var mapDiv = $("<div class='picker-map'>Učitavam</div>").css({
                ...
                function findAddress(){
                    var address = $(that).val();
                    if(address == ""){
                        alert("Unesite adresu ili lat/lng koordinate.");
                    }else{
                        if(isLngLat(address)){
                            showPicker();
                        }else{
                            geocoder.geocode( {'address': address, 'region': 'uk'}, function(results, status) {
                                if (status == google.maps.GeocoderStatus.OK) {
                                    ...
                                    alert("Geocode greška! Razlog: " + status);
                                }
                            });
                        }
                        $(that).focus();
