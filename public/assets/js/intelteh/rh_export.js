...
$(document).ready(function() {
    ...
    $('#preview').click(function() { /* PREVIEW DATA */
        $('#exportform').attr('action', page_url + 'rh_export/' + device_id)
        .submit();
    });

    $('#xls').click(function() { /* DOWNLOAD XLS */
        $('#exportform').attr('action', page_url + 'rh_export/' + device_id + '/xls')
        .submit();
    });

    $('#pdf').click(function() { /* DOWNLOAD XLS */
        $('#exportform').attr('action', page_url + 'rh_export/' + device_id + '/pdf')
        .submit();
    });
